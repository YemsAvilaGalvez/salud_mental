...
<body>
    ...
    <!-- Sparkline Js-->
    <script src="../style/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>

    <!-- Chart Js-->
    <script src="../style/plugins/jquery-knob/jquery.knob.min.js"></script>

    <!-- Chart Custom Js-->
    <script src="../style/assets/pages/knob-chart-demo.js"></script>


    <!-- Morris Js-->
    <script src="../style/plugins/morris-js/morris.min.js"></script>

    <!-- Raphael Js-->
    <script src="../style/plugins/raphael/raphael.min.js"></script>

    <!-- Custom Js -->
    <script src="../style/assets/pages/dashboard-demo.js"></script>
