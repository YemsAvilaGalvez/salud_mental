                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect"><i
                                        class="mdi mdi-poll"></i><span>Seguimiento</span></a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id01_view.php')">ID01</a></li>
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id02_view.php')">ID02</a></li>
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id03_view.php')">ID03</a></li>
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id04_view.php')">ID04</a></li>
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id05_view.php')">ID05</a></li>
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id06_view.php')">ID06</a></li>
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id07_view.php')">ID07</a></li>
                                    <li><a href="#" onclick="cargar_contenido('contenido_principal','seguimiento/id08_view.php')">ID08</a></li>
