                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link" onclick="cargar_contenido('contenido_principal','diagnosticos_view/id07.php')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>ID07</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link" onclick="cargar_contenido('contenido_principal','diagnosticos_view/id08.php')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>ID08</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link" onclick="cargar_contenido('contenido_principal','diagnosticos_view/id10.php')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>ID10</p>
                                    </a>
                                </li>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Pacientes <b class="text-success">Total Pacientes</b></span>
                <span class="info-box-number" id="totalPacientesUnicos"></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-12">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0" id="tablaPacientesIntervencion">
                    <thead>
                    <tr>
                      <th>Cita</th>
                      <th>Pciente</th>
              ...
              <div class="card-footer clearfix">
                ...
                <p class=" float-right" id="">Primeros 10 con más prioridad</p>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
