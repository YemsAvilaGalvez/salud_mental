 ...
 ********************************************************************/
var tbl_id04_r;
function Listar_Id04_R() {
  //enviarlo al scrip en MANTENIMIENTO ROL
  tbl_id04_r = $("#tabla_id04_r").DataTable({
    responsive: true,
    ordering: true,
    bLengthChange: true,
    searching: { regex: false },
    ...
    processing: true,
    ajax: {
      url: "../controller/diagnostico/controlador_id04R_listar.php",
      type: "POST",
    },
    /*
                  dom: "Blfrtip",
  ...
  tbl_id04_r.on("draw.td", function () {
    var PageInfo = $("#tabla_id04_r").DataTable().page.info();
    tbl_id04_r
      .column(0, { page: "current" })
      .nodes()
      .each(function (cell, i) {
