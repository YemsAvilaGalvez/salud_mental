 ...
 ********************************************************************/
var tbl_id05_r;
function Listar_Id05_R() {
  //enviarlo al scrip en MANTENIMIENTO ROL
  tbl_id05_r = $("#tabla_id05_r").DataTable({
    responsive: true,
    ordering: true,
    bLengthChange: true,
    searching: { regex: false },
    ...
    processing: true,
    ajax: {
      url: "../controller/diagnostico/controlador_id05R_listar.php",
      type: "POST",
    },
    /*
                  dom: "Blfrtip",
  ...
  tbl_id05_r.on("draw.td", function () {
    var PageInfo = $("#tabla_id05_r").DataTable().page.info();
    tbl_id05_r
      .column(0, { page: "current" })
      .nodes()
      .each(function (cell, i) {
