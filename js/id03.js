 ...
 ********************************************************************/
var tbl_id03_r;
function Listar_Id03_R() {
  //enviarlo al scrip en MANTENIMIENTO ROL
  tbl_id03_r = $("#tabla_id03_r").DataTable({
    responsive: true,
    ordering: true,
    bLengthChange: true,
    searching: { regex: false },
    ...
    processing: true,
    ajax: {
      url: "../controller/diagnostico/controlador_id03R_listar.php",
      type: "POST",
    },
    /*
                  dom: "Blfrtip",
  ...
  tbl_id03_r.on("draw.td", function () {
    var PageInfo = $("#tabla_id03_r").DataTable().page.info();
    tbl_id03_r
      .column(0, { page: "current" })
      .nodes()
      .each(function (cell, i) {
