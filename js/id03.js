...
function Listar_Id03() {
  ...
  tbl_id03 = $("#tabla_id03").DataTable({
    ...
    buttons: [
      {
        ...
        title:
          fechaFormateada +
          "-REPORTE TRATAMIENTO ESPECIALIZADO DE NIÑOS, NIÑAS Y ADOLESCENTES AFECTADOS POR MALTRATO INFANTIL",
        exportOptions: {
          columns: [
    ...
    columns: [
      ...
      { data: "Anio" },
      { data: "Mes" },
      { data: null, defaultContent: "TRATAMIENTO ESPECIALIZADO DE NIÑOS, NIÑAS Y ADOLESCENTES AFECTADOS POR MALTRATO INFANTIL" },
      { data: "fecha_medica1" },
      { data: "fecha_medica2" },
      { data: "fecha_medica3" },
      {
    ...
    rowCallback: function (row, data) {
      ...
      let porcentaje_total = parseFloat(data.porcentaje_total
