 ...
 ********************************************************************/
var tbl_id08;
function Listar_Id08() {
  //enviarlo al scrip en MANTENIMIENTO ROL
  tbl_id08 = $("#tabla_id08").DataTable({
    responsive: true,
    ordering: true,
    bLengthChange: true,
    ...
    processing: true,
    ajax: {
      url: "../controller/diagnostico/controlador_id08_listar.php",
      type: "POST",
    },
    /*
                               dom: "Blfrtip",
    ...
    columns: [
      ...
      { data: "Anio" },
      { data: "Mes" },
      { data: "Acompanamiento_clinico_Psicosocial" },
  ...
  tbl_id08.on("draw.td", function () {
    var PageInfo = $("#tabla_id08").DataTable().page.info();
    tbl_id08
